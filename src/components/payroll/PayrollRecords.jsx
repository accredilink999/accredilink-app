...
import { Download, FileText, Eye, Pencil, CheckCircle, Trash2, MoreVertical } from 'lucide-react';
        ...
        {selectedIds.length > 0 && (
          <div className="flex gap-2 ml-auto flex-wrap">
            <Button size="sm" variant="outline"
              ...
              <CheckCircle className="w-4 h-4 mr-1" /> Approve ({selectedIds.length})
            </Button>
            <Button size="sm" className="bg-green-600 hover:bg-green-700"
              onClick={() => updateStatusMutation.mutate({ ids: selectedIds, status: 'paid' })}>
