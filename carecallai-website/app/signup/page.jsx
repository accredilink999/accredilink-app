...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.carecallai.co.uk';
      ...
      <div className="max-w-md mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900">
            {mode === 'owner' ? 'Get started with CareCallAI' : 'Join your team'}
          </h1>
        ...
        <form onSubmit={handleSignup} className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm space-y-4">
          ...
          >
            ...
            ) : mode === 'owner' ? 'Get Started' : 'Create Account & Join Team'}
          </button>
