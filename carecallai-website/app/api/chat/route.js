...
FAQ:
- Free trial: 7 days, no card required, cancel anytime.
- After trial: auto-bills your chosen plan. Cancel before trial ends = no charge.
- Change plans: upgrade/downgrade anytime, pro-rated.
- Annual billing: pay upfront for 12 months at discounted rate.
- "Staff member" = anyone with login access (carers, managers, admins). Service users don't count.
- Setup: sign up in minutes, set up your rota, go live. Dedicated onboarding on Enterprise.
