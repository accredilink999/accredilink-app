// Blog post data — static for now, can move to CMS later
const posts = [
  {
    slug: "5-signs-your-care-agency-needs-better-software",
    title: "5 Signs Your Care Agency Needs Better Software",
    description: "Still using paper rotas and spreadsheets? Here are five signs it's time to upgrade to proper care management software.",
    date: "2026-02-24",
    category: "Getting Started",
    readTime: "4 min read",
    content: `
Many domiciliary care agencies start with paper-based systems — handwritten rotas, paper MAR charts, filing cabinets full of care plans. It works when you have a handful of staff and clients. But as you grow, the cracks start to show.
...
CareCallAI is built specifically for UK domiciliary care agencies — with everything from scheduling to MAR charts to CIW/CQC compliance. Start your free trial to see the difference.
  ...
  {
    slug: "ciw-vs-cqc-whats-the-difference",
    title: "CIW vs CQC: What's the Difference?",
    description: "A clear guide to the differences between Care Inspectorate Wales (CIW) and the Care Quality Commission (CQC) for domiciliary care agencies.",
    date: "2026-02-24",
    category: "Compliance",
    readTime: "5 min read",
    content: `
...
| Area | CIW | CQC |
|------|-----|-----|
| Covers | Wales | England |
| Legislation | RISCA 2016 | HSCA 2008 |
| Rating system | No formal ratings | 4-level rating |
| Language support | Welsh and English | English |
| Inspection style | Themed inspections | KLoE-based |
...
CareCallAI covers both regulators, with specific features tailored to CIW (Wales) and CQC (England) requirements.
  ...
  {
    slug: "why-paper-rotas-are-costing-you-money",
    title: "Why Paper Rotas Are Costing You Money",
    description: "Paper rotas waste time, cause errors and make compliance harder. Here's how much they're really costing your care agency.",
    date: "2026-02-24",
    category: "Scheduling",
    readTime: "4 min read",
    content: `
...
At £49/month, it pays for itself in the first week of coordinator time saved.
  ...
  {
    slug: "electronic-mar-charts-explained",
    title: "Electronic MAR Charts Explained",
    description: "Everything you need to know about electronic MAR charts for domiciliary care — what they are, why they matter, and how to choose the right system.",
    date: "2026-02-24",
    category: "Medication",
    readTime: "6 min read",
    content: `
...
1. **Medications are set up** with name, dose, frequency and time of day (Morning, Afternoon, Evening, Night, As Needed)
2. **Carers open the MAR chart** on their phone during a visit
3. **They record each medication** as Given (G), Refused (R) or Destroyed (D) with their digital signature
