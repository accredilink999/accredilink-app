    ...
    <>
      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 relative">
          ...
          <span className="inline-block px-2.5 py-1 bg-white/10 text-white/80 text-xs font-medium rounded-full mb-4">Family Advice</span>
          <h1 className="text-3xl sm:text-4xl font-bold text-white leading-tight">10 Signs Your Elderly Parent May Need Care at Home</h1>
        </div>
      </section>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Worried About a Loved One?</h2>
          <p className="text-slate-600 mb-6">If you have noticed some of these signs and want to talk through your options, we are here to listen. No pressure, no obligation &mdash; just friendly, honest advice.</p>
