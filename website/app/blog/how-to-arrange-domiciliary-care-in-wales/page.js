...
export default function HowToArrangeDomiciliaryCareInWales() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "Article",
        headline: "How to Arrange Domiciliary Care in Wales: A Complete Guide",
        description: "A step-by-step guide to arranging domiciliary care in Wales. Learn how to organise home care, navigate local authority assessments, and find the right provider in Denbighshire, Conwy, and Wrexham.",
        ...
        url: "https://accredilinkcare.co.uk/blog/how-to-arrange-domiciliary-care-in-wales",
        mainEntityOfPage: "https://accredilinkcare.co.uk/blog/how-to-arrange-domiciliary-care-in-wales",
      }) }} />
      ...
      <article className="py-16 sm:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-slate prose-lg">
          ...
          <ul>
            ...
            <li>Forgetting to take medication or taking it incorrectly</li>
            <li>Struggling to prepare meals or losing weight</li>
            <li>Increasing frequency of falls or near-misses</li>
            <li>Growing isolation and withdrawal from social activities</li>
          ...
          <ul>
            ...
            <li><strong>Conwy County Borough Council</strong> &mdash; Single Point of Access (SPoA)</li>
          ...
          <ul>
            ...
            <li>Mental health and cognitive function</li>
            <li>The person&rsquo;s own views and preferences</li>
            <li>The home environment and any risks</li>
            <li>Existing support from family or friends</li>
          ...
          <ul>
            ...
            <li>Be asked to contribute a set amount per week, up to the Welsh cap</li>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Ready to Arrange Care at Home?</h2>
          <p className="text-slate-600 mb-6">We support families across Denbighshire, Conwy, and Wrexham. Get in touch for a free, no-obligation conversation about your care needs.</p>
