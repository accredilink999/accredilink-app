...
const quickLinks = [
  ...
  { href: '/brochure/care', label: 'Download Brochure' },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.trustpilot.com/review/accredilinkcare.co.uk" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#00B67A] transition-colors" aria-label="Trustpilot">
